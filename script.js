const presetCartoons = [
  ...
  { title: "Kopfrechnen", src: "cartoons/4Bier.png", description: "" },
  { title: "Unterhopfung", src: "cartoons/Unterhopfung.png", description: "" },
  { title: "Sonnenbrand", src: "cartoons/Sonnenbrand.png", description: "" },
  { title: "Kundenwunsch", src: "cartoons/Kundenwunsch.png", description: "" },
  { title: "weitsichtig", src: "cartoons/weitsichtig.png", description: "" },
  { title: "Zaubermittel", src: "cartoons/Astra.png", description: "" },
  { title: "Produktvorstellung", src: "cartoons/Entwuerdingung.png", description: "" },
  { title: "Neue Wege", src: "cartoons/NeueWege.png", description: "" },
  { title: "Freundlichkeit ist alles", src: "cartoons/Freundlichkeit.png", description: "" },
  { title: "Andere Länder, andere Sitten", src: "cartoons/FALSTAFF.png", description: "" },
  { title: "Aber gern doch", src: "cartoons/neueZeiten.png", description: "" },
  { title: "Spitzenservice", src: "cartoons/Gastro.png", description: "" },
  { title: "Echte Männersache", src: "cartoons/zahnbuerste.png", description: "" },
  ...
  { title: "Divergenz", src: "cartoons/Divergenz.png", description: "" },
  { title: "Kollateralschaden", src: "cartoons/Kollateralschaden.png", description: "" },
  { title: "Etikette", src: "cartoons/Etikette.png", description: "" },
  { title: "Bildnis eines Unbekannten", src: "cartoons/BildnisEinesUnbekannten.png", description: "" },
  { title: "Zugeschnitten", src: "cartoons/Kunst.png", description: "" },
  { title: "Berühmter Patient", src: "cartoons/BeruehmterPatient.png", description: "" },
  { title: "72 Jungfrauen", src: "cartoons/IMG-20240630-WA0005.jpg", description: "" },
  { title: "Alle Jahre wieder", src: "cartoons/AlleJahreWieder.png", description: "" },
  { title: "Wahrheitsgetreu", src: "cartoons/wahrheitsgetreu.png", description: "" },
  { title: "Berufsrisiko", src: "cartoons/berufsrisiko.jpg", description: "" },
  { title: "Nur für Privilegierte", src: "cartoons/privilegierte.png", description: "" },
